...
{
    public class WebAuthenticationService : Coti.Services.IAuthenticationService<int>
    {
        ...
        {
            Coti.Models.Domain.UserBase baseUser = null;
        ...
        {
            Coti.Models.Domain.UserBase baseUser = new UserBase();
